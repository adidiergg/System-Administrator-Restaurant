 ...
 */
public class nuevo_cliente_control implements Initializable {
    ...
    private void agregarCliente(MouseEvent event) {
        ...
        try{
         ...
         sentencia = conn.prepareStatement("INSERT INTO clientes( rfc_cl,nombres_cl,apellidop_cl,apellidom_cl,direccion_cl,cp_cl,correo_cl,celular_cl) VALUES (?,?,?,?,?,?,?,?)");
