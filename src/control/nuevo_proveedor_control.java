 ...
 */
public class nuevo_proveedor_control implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        RegexValidator validar_correo  = new RegexValidator();
        validar_correo.setRegexPattern("/\\S+@\\S+\\.\\S+/");
        RegexValidator validar_telefono = new RegexValidator();
        validar_telefono.setRegexPattern("^[0-9]{1,10}$");
        tbox_correo.getValidators().add(validar_correo);
    ...
    @FXML
    private void agregarProveedor(MouseEvent event) {
        ...
        try{
         ...
         sentencia = conn.prepareStatement("INSERT INTO proveedores( nombre_pr, telefono_pr,correo_pr) VALUES (?,?,?)");
